...
export default function Detail() {
  ...
  const message = `Olá Amigo Bixo, estou entrando em contato pois estou interessado em ajudar no caso "${incident.name}" com o valor de ${ Intl.NumberFormat('pt-BR', { style: 'currency', currency: 'BRL'}).format(incident.value) }.`;
